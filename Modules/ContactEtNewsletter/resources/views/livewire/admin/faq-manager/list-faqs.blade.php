<div class="p-4 sm:p-6 lg:p-8 bg-gray-50 dark:bg-gray-900 min-h-screen transition-colors duration-300">
    ...
    <div class="max-w-7xl mx-auto flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-10">
        <div>
            <h1 class="text-3xl sm:text-4xl font-extrabold dark:text-white bg-clip-text text-transparent bg-green-600 leading-tight">
                FAQ Manager
            </h1>
        ...
        <button
            ...
            class="group flex items-center gap-2 bg-green-600 text-white font-bold px-6 py-3 rounded-xl shadow-lg hover:shadow-2xl hover:bg-green-600 transform hover:scale-[1.03] transition-all duration-300 focus:ring-4 focus:ring-green-500 focus:ring-opacity-50"
        >
            ...
            >
                <div class="p-4 cursor-pointer" @click="open = !open">
                    <div class="flex justify-between items-start">
                        ...
                        <div class="flex flex-col items-end gap-1 flex-shrink-0">
                            ...
                            {{-- Icône de flèche --}}
                            <svg :class="open ? 'rotate-180' : ''" class="w-5 h-5 text-green-500 transition-transform mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div x-show="open" x-transition x-cloak class="px-4 pb-4 border-t border-gray-100 dark:border-gray-700">
                    ...
                    <div class="flex gap-4 mt-4 pt-3 border-t border-dashed border-gray-200 dark:border-gray-700">
                        <button wire:click="$dispatch('open-edit-faq', { faqId: {{ $faq->id }} })" class="text-green-600 dark:text-green-400 font-bold text-sm hover:underline transition">Éditer</button>
    ...
    <div class="hidden sm:block max-w-7xl mx-auto bg-white dark:bg-gray-800 rounded-2xl shadow-2xl overflow-hidden border border-gray-100 dark:border-gray-700">
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                <thead class="bg-green-600 text-white shadow-md sticky top-0">
                <tr>
                ...
                @forelse ($faqs as $faq)
                    <tr class="hover:bg-green-50/50 dark:hover:bg-gray-700/50 transition-all duration-300 cursor-pointer">
                        ...
                        <td class="px-6 py-4 text-center text-xs hidden lg:table-cell">
                                <span class="inline-flex items-center px-3 py-1 rounded-full font-mono text-xs font-extrabold bg-green-100 text-green-600 dark:bg-green-900 dark:text-green-300">
                                    {{ $faq->order }}
                                </span>
                        </td>
                        ...
                        <td class="px-6 py-4 text-center space-x-4">
                            <button wire:click.stop="$dispatch('open-edit-faq', { faqId: {{ $faq->id }} })" class="text-green-600 dark:text-green-400 font-bold hover:underline transition">Éditer</button>
                    ...
                    <tr>
                        <td colspan="4" class="px-6 py-20 text-center">
                            <div class="text-gray-400 dark:text-gray-600">
                                <svg class="w-16 h-16 mx-auto mb-4 text-green-400 dark:text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
