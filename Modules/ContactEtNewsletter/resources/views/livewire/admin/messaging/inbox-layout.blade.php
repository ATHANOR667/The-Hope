    ...
    >
        @if($selectedConversationId)
            <div class="p-4 border-b border-gray-100 dark:border-gray-700 md:hidden bg-white dark:bg-gray-800 sticky top-0 z-20 shadow-sm">
                <button
                    ...
                    class="text-indigo-600 dark:text-indigo-400 font-bold flex items-center text-base hover:text-indigo-700 transition"
                >
        ...
        @if($selectedConversationId)
            <button
                ...
                class="fixed bottom-6 right-6 md:hidden z-30 w-14 h-14 rounded-full bg-indigo-600 text-white shadow-xl flex items-center justify-center hover:bg-indigo-700 transition"
                title="Répondre"
            >
