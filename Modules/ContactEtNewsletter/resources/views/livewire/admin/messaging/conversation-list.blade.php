<div class="flex flex-col h-full  rounded-2xl  transition-colors duration-300">
    ...
    <div class="p-4 sticky top-0 z-10  border-b border-gray-100 dark:border-gray-700 rounded-t-2xl transition-colors duration-300">
        ...
        <input
            ...
            class="w-full px-4 py-2 text-sm border-2 border-gray-200 dark:border-gray-700 rounded-lg focus:ring-indigo-500 focus:border-indigo-500 bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 transition-all duration-300 "
        >
        ...
        <div class="flex flex-wrap gap-3 mt-4 text-sm font-medium">
            ...
            <select wire:model.live="statusFilter"
                    class="flex-1 min-w-[120px] appearance-none px-4 py-2 border border-gray-200 dark:border-gray-600 rounded-xl
                       ...
                       hover:border-indigo-300 dark:hover:border-indigo-500 focus:ring-indigo-500 focus:border-indigo-500 ">
    ...
    <div class="flex-1 overflow-y-auto">
        ...
        @else
            <div class="p-8 text-center text-gray-500 dark:text-gray-400">
                <svg class="w-12 h-12 mx-auto mb-4 text-indigo-500 dark:text-indigo-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
