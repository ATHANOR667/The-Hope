...
<div class="max-w-xl mx-auto bg-white shadow-lg rounded-xl overflow-hidden border border-gray-200">
    ...
    <div class="p-6 space-y-6">
        ...
        <div class="text-center pt-4">
              <a href="{{ route( route('visitor.contact-us')}}" class="inline-block px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-blue-600 shadow-lg hover:bg-blue-700 transition duration-150 transform hover:scale-105">
