        ...
        <form action="{{ $psp === 'stripe' ? route('payment.donate.stripe') : route('payment.donate.notchpay') }}" method="POST" class="space-y-6">
            ...
            @if($psp === 'stripe')
                <div aria-live="polite"> @if($isConverting)
                        <div class="p-3 bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-800 rounded-xl flex items-center text-sm text-blue-700 dark:text-blue-300">
