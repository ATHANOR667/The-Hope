...
<div wire:loading.delay.longest class="fixed inset-0 z-[9999] flex items-center justify-center bg-gray-900 bg-opacity-75 transition-opacity duration-300 ease-in-out" x-cloak>
...
<footer class="bg-white dark:bg-gray-800 text-gray-600 dark:text-gray-300 p-4 text-center shadow-inner mt-auto transition-colors duration-300 ease-in-out">
    <div class="container mx-auto">
        <p class="text-sm md:text-base">&copy; {{ date('Y') }} Owner Panel. Tous droits réservés.</p>
    </div>
</footer>
</body>
</html>
