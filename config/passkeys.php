...
return [
     ...
     */
    'redirect_to_after_login' => config('app.url').'/admin/profile',
    ...
    'relying_party' => [
        ...
        'id' => 'intergonial-admirably-carolee.ngrok-free.dev',
        'icon' => null,
    ],
    ...
    'models' => [
        ...
        'authenticatable' => env('AUTH_MODEL', \Modules\AdminBase\Models\Admin::class),
    ],
];
