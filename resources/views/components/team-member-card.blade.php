...
<div class="flex-shrink-0 w-full sm:w-[380px] lg:w-[420px] p-4 snap-center">
    <div
        class="bg-white dark:bg-gray-800 shadow-xl rounded-4xl overflow-hidden transform hover:scale-[1.02] hover:shadow-indigo-500/30 transition duration-500 ease-in-out border border-gray-100 dark:border-gray-700 h-full flex flex-col"
        x-data="{
    ...
    >
        ...
        <div class="relative h-64 w-full bg-gray-200 dark:bg-gray-900 shadow-inner group overflow-hidden">
            ...
            @elseif ($mediaType === 'iframe')
                ...
                <div x-show="!isVideoPlaying"
                     ...
                     class="absolute inset-0 flex flex-col items-center justify-center bg-indigo-900/60 backdrop-blur-sm transition-opacity duration-500 group-hover:bg-indigo-900/40 cursor-pointer"
                     x-cloak>
                    <button aria-label="Lancer la vidéo"
                            class="p-5 rounded-full bg-white/95 text-indigo-600 shadow-xl ring-4 ring-indigo-500/60 transition-all duration-300 transform hover:scale-110 hover:bg-white">
        ...
        <div class="p-6 md:p-7 text-center flex-grow flex flex-col">
            ...
            <p class="text-xl text-indigo-700 dark:text-indigo-400 font-bold mb-4">
                {{ $role }}
            </p>

            {{-- Citation --}}
            <div class="relative mb-6 p-4 bg-gray-50 dark:bg-gray-700/30 rounded-xl border-l-4 border-indigo-500">
            ...
            <div class="text-base text-gray-700 dark:text-gray-300 leading-relaxed mb-4 flex-grow transition-all duration-500 ease-in-out overflow-hidden"
                ...
                <div x-show="showDetail" class="text-left mt-0 space-y-3" x-cloak>
                    ...
                    <div class="p-4 bg-indigo-50/50 dark:bg-indigo-900/20 rounded-lg">
                        <p class="font-bold text-indigo-600 dark:text-indigo-400 mb-3 text-lg">Faits Clés :</p>
            ...
            <button
                ...
                class="w-full py-3 mt-2 font-semibold rounded-xl transition duration-300 shadow-md focus:outline-none focus:ring-4 focus:ring-indigo-500/50 transform hover:scale-[1.01]"
                :class="showDetail ? 'bg-gray-700 hover:bg-gray-800 text-white dark:bg-gray-600 dark:hover:bg-gray-500' : 'bg-indigo-600 hover:bg-indigo-700 text-white'"
            >
