<div class="fixed top-6 right-6 z-[1000] w-full max-w-md"
     x-data="{
         show: <?php if ((object) ('show') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('show'->value()); ?>')<?php echo e('show'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('show'); ?>')<?php endif; ?>,
         timeout: null,
         hide() {
             this.show = false;
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($message): ?>
        ...
        ?>
        <div class="relative rounded-2xl shadow-xl border border-gray-200/50 dark:border-gray-700/50 bg-opacity-90 backdrop-blur-sm text-white <?php echo e($colors[$type]); ?> overflow-hidden">
            <div class="p-5 flex items-start gap-4">
                ...
                <div class="flex-1 w-0">
                    <p class="text-base font-medium leading-6 tracking-tight"><?php echo e($titles[$type]); ?></p>
                    <p class="mt-1.5 text-sm leading-5 opacity-95 font-light"><?php echo e($message); ?></p>
                </div>
...
<?php /**PATH /home/athanor/Documents/PhpstormProjects/Hope/Modules/Shared/resources/views/livewire/flash-notification.blade.php ENDPATH**/ ?>