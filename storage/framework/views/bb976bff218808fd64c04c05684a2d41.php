...
<head>
    ...
    <title><?php echo e($newsletterMessage->title); ?></title>
</head>
            ...
            <table width="600" border="0" cellspacing="0" cellpadding="0" role="presentation" style="max-width: 600px; border-collapse: collapse; background-color: #ffffff; border-radius: 12px; overflow: hidden; border: 1px solid #e5e7eb; box-shadow: 0 10px 20px -5px rgba(0, 0, 0, 0.1);">
                ...
                <tr>
                    <td style="padding: 20px 30px; border-bottom: 2px solid #D1FAE5;">
                        <h2 style="font-size: 24px; font-weight: 700; color: #1f2937; margin: 0; line-height: 1.3;">
                            <?php echo e($newsletterMessage->title); ?>
                ...
                <tr>
                    <td class="wysiwyg-content" style="padding: 30px;">
                        <div style="font-size: 16px; color: #4b5563; line-height: 1.8;">
                            <?php echo $newsletterMessage->content; ?>
                ...
                <tr>
                    <td style="padding: 30px; background-color: #F0FDF4; border-top: 1px solid #e5e7eb;">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($newsletterMessage->type === 'goodbye'): ?>
                            <div style="text-align: center; background-color: #FEF3C7; padding: 20px; border: 1px solid #FCD34D; border-radius: 8px; margin-bottom: 20px;">
                                ...
                                <a href="<?php echo e(route('visitor.contact-us')); ?>" style="display: inline-block; font-size: 14px; font-weight: 600; color: #D97706; text-decoration: none; border-bottom: 1px solid #D97706;">
                                    Partager votre feedback
                                </a>
                            </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($newsletterMessage->type, ['welcome', 'newsletter'])): ?>
                            ...
                            <div style="text-align: center; padding-top: 8px;">
                                <a href="<?php echo e(route('visitor.newsletter.manage', ['token' => $subscriber->token])); ?>"
                        ...
                        <div style="text-align: center; font-size: 12px; color: #6B7280; line-height: 1.5;">
                            ...
                            <p style="margin: 8px 0 0 0;">&copy; <?php echo e(date('Y')); ?> <?php echo e(config('app.name')); ?>. Tous droits réservés.</p>
                        </div>
                    </td>
                </tr>
            </table>
...
<img src="<?php echo e(route('visitor.newsletter.track', ['d' => $delivery->id])); ?>" width="1" height="1" alt="" style="display: none !important; mso-hide: all; opacity: 0;" />

</body>
</html>
<?php /**PATH /home/athanor/Documents/PhpstormProjects/Hope/Modules/ContactEtNewsletter/resources/views/mail/newsletter-message-mail.blade.php ENDPATH**/ ?>