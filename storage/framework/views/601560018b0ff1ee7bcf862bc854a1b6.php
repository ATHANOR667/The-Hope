<div x-data="{ isOpen: false, isVerifying: false }"
     x-on:open-create-modal.window="isOpen = true"
     x-on:close-create-modal.window="isOpen = false; $wire.resetInputFields()"
     x-on:request-passcode-verification.window="if ($event.detail.component === '<?php echo e($this->getName()); ?>') isVerifying = true"
     x-on:execute-create-post.window="isVerifying = false"
     @keyup.escape.window="if (!isVerifying) { isOpen = false; $wire.resetInputFields() }">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'coreui::components.modal','data' => ['wire:model' => 'isOpen','title' => 'Créer un Post Galerie','maxWidth' => '2xl']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'isOpen','title' => 'Créer un Post Galerie','maxWidth' => '2xl']); ?>
        <div class="space-y-8">
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model.live.debounce.300ms' => 'title','label' => 'Titre du Post','placeholder' => 'Titre accrocheur...','error' => ''.e($errors->first('title')).'','required' => true]); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="space-y-4 pt-6 border-t border-slate-100 dark:border-slate-800">
                <div class="flex items-center justify-between">
                    <div>
                        <h4 class="font-bold text-slate-900 dark:text-white">Médias</h4>
                        <p class="text-xs text-slate-500">Images ou Vidéos (Fichiers ou URLs)</p>
                    </div>
...
<?php endif; ?>
                ...
                <div class="space-y-4 max-h-[40vh] overflow-y-auto pr-2 custom-scrollbar">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $enhancedMediaInputs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $media): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div wire:key="media-<?php echo e($index); ?>"
                             class="p-4 rounded-2xl border-2 border-dashed border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/50 relative group transition-all duration-200 hover:border-primary/30">

                            <button type="button" wire:click="removeMedia(<?php echo e($index); ?>)"
                                    class="absolute top-3 right-3 p-1.5 text-slate-400 hover:text-danger hover:bg-danger/10 rounded-lg transition-all duration-200">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'coreui::components.select','data' => ['wire:model.live' => 'mediaInputs.'.e($index).'.type','label' => 'Type de source','size' => 'sm']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model.live' => 'mediaInputs.'.e($index).'.type','label' => 'Type de source','size' => 'sm']); ?>
...
<?php endif; ?>
                                ...
                                <div>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($media['type'] == 'file'): ?>
                                        <label class="block text-xs font-medium text-slate-500 mb-1">Téléverser (Max 10MB)</label>
                                        <input type="file" wire:model="mediaInputs.<?php echo e($index); ?>.value"
                                               accept="image/jpeg,image/png,video/mp4,video/mov,video/webm"
                                               class="block w-full text-xs text-slate-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-xs file:font-semibold file:bg-primary/10 file:text-primary hover:file:bg-primary/20 transition-all duration-200">
                                        <div wire:loading wire:target="mediaInputs.<?php echo e($index); ?>.value" class="mt-2 text-[10px] text-primary flex items-center gap-1">
                                    ...
                                    <?php else: ?>
                                        <?php if (isset($component)) { $__componentOriginald403b78e8b12be0ca768bd08f9c25b1f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald403b78e8b12be0ca768bd08f9c25b1f = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'coreui::components.input','data' => ['wire:model.live.debounce.500ms' => 'mediaInputs.'.e($index).'.value','label' => 'URL du média','placeholder' => 'https://...','size' => 'sm']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('coreui::input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model.live.debounce.500ms' => 'mediaInputs.'.e($index).'.value','label' => 'URL du média','placeholder' => 'https://...','size' => 'sm']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginald403b78e8b12be0ca768bd08f9c25b1f)): ?>
<?php $attributes = $__attributesOriginald403b78e8b12be0ca768bd08f9c25b1f; ?>
...
<?php endif; ?>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($media['preview_url']): ?>
                                <div class="mt-4 relative rounded-xl overflow-hidden bg-slate-900 aspect-video flex items-center justify-center border border-slate-200 dark:border-slate-800">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ["mediaInputs.{$index}.value"];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <div class="py-12 text-center border-2 border-dashed border-slate-200 dark:border-slate-800 rounded-2xl bg-slate-50/50 dark:bg-slate-900/50">
                            <p class="text-sm text-slate-500">Aucun média ajouté. Cliquez sur "Ajouter" pour commencer.</p>
                        </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="flex gap-3 pt-6 border-t border-slate-100 dark:border-slate-800">
                <?php if (isset($component)) { $__componentOriginal580e1af29f3b65fbd4f30017fc1d1333 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal580e1af29f3b65fbd4f30017fc1d1333 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'coreui::components.button','data' => ['variant' => 'secondary','outline' => true,'class' => 'flex-1','xOn:click' => 'isOpen = false; $wire.resetInputFields()']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('coreui::button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'secondary','outline' => true,'class' => 'flex-1','x-on:click' => 'isOpen = false; $wire.resetInputFields()']); ?>
                    Annuler
                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal580e1af29f3b65fbd4f30017fc1d1333)): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'coreui::components.button','data' => ['class' => 'flex-1','wire:click' => '$dispatch(\'request-passcode-verification\', {
                        ...
                        action: \'execute-create-post\',
                        guard: \'admin\'
                    })','wire:loading.attr' => 'disabled','wire:target' => 'execute-create-post, create, mediaInputs.*.value']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('coreui::button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php $component->withAttributes(['class' => 'flex-1','wire:click' => '$dispatch(\'request-passcode-verification\', {
                        ...
                        action: \'execute-create-post\',
                        guard: \'admin\'
                    })','wire:loading.attr' => 'disabled','wire:target' => 'execute-create-post, create, mediaInputs.*.value']); ?>
                    <span wire:loading.remove wire:target="execute-create-post, create, mediaInputs.*.value">Créer le Post</span>
                    <span wire:loading wire:target="execute-create-post, create, mediaInputs.*.value" class="flex items-center justify-center">
...
<?php /**PATH /home/athanor/Documents/PhpstormProjects/Hope/Modules/GalerieModule/resources/views/livewire/admin/galerie/create-post.blade.php ENDPATH**/ ?>