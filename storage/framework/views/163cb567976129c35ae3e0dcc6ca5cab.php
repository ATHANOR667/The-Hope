...
<head>
    ...
    <meta name="description" content="<?php echo e($layoutContent->meta['description']); ?>">
    <meta name="keywords" content="<?php echo e($layoutContent->meta['keywords']); ?>">
    <meta name="author" content="<?php echo e($layoutContent->meta['author']); ?>">

    <meta property="og:title" content="<?php echo $__env->yieldContent('title', $layoutContent->meta['og:title'] ); ?>">
    <meta property="og:description" content="<?php echo e($layoutContent->meta['og:description']); ?>">
    <meta property="og:url" content="<?php echo e(url()->current()); ?>">
    <meta property="og:type" content="website">
    <meta property="og:image" content="<?php echo e($layoutContent->meta['og:image']); ?>">
    <meta property="og:image:width" content="<?php echo e($layoutContent->meta['og:image:width']); ?>">
    <meta property="og:image:height" content="<?php echo e($layoutContent->meta['og:image:height']); ?>">

    <meta name="twitter:card" content="summary_large_image">
    <link rel="icon" type="image/x-icon" href="<?php echo e($layoutContent->meta['og:image']); ?>">
    <link rel="icon" type="image/png" sizes="32x32" href="<?php echo e($layoutContent->meta['og:image']); ?>">
    <link rel="apple-touch-icon" sizes="180x180" href="<?php echo e($layoutContent->meta['og:image']); ?>">
    ...
    <title><?php echo $__env->yieldContent('title',  $layoutContent->meta['title'] ); ?></title>
</head>
...
<header class="bg-white/70 dark:bg-gray-900/70 backdrop-blur-2xl shadow-md sticky top-0 z-50 transition-colors duration-300 ease-in-out border-b border-gray-200/50 dark:border-gray-700/50">
    <nav class="container mx-auto px-4 py-4 flex justify-between items-center">
        <a href="<?php echo e(route('visitor.accueil')); ?>" class="flex items-center space-x-3 focus:outline-none focus:ring-2 focus:ring-green-500 rounded-md p-1 -m-1">
            <img src="<?php echo e($layoutContent->meta['og:image']); ?>" alt="The Hope Charity Logo" class="h-9 w-auto rounded-full">
        ...
        <div class="hidden md:flex items-center space-x-6">
            <a href="<?php echo e(route('visitor.accueil')); ?>"
               class="text-gray-600 dark:text-gray-300 hover:text-green-600 dark:hover:text-green-400 font-medium transition-all duration-200 pb-1 <?php echo e(request()->routeIs('visitor.accueil') ? 'text-green-600 dark:text-green-400 border-b-2 border-green-500 font-bold' : ''); ?>">Accueil</a>

            <a href="<?php echo e(route('visitor.galerie')); ?>"
               class="text-gray-600 dark:text-gray-300 hover:text-green-600 dark:hover:text-green-400 font-medium transition-all duration-200 pb-1 <?php echo e(request()->routeIs('visitor.login') ? 'text-green-600 dark:text-green-400 border-b-2 border-green-500 font-bold' : ''); ?>">Galerie</a>

            <a href="<?php echo e(route('visitor.contact-us')); ?>"
               class="text-gray-600 dark:text-gray-300 hover:text-green-600 dark:hover:text-green-400 font-medium transition-all duration-200 pb-1 <?php echo e(request()->routeIs('visitor.about-us') ? 'text-green-600 dark:text-green-400 border-b-2 border-green-500 font-bold' : ''); ?>">Nous Contacter</a>

            
            <a href="<?php echo e(route('visitor.donate')); ?>"
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-827533447-0', $__key);
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 pb-8 border-b border-gray-200/50 dark:border-gray-700/50">
            <div class="col-span-1">
                ...
                <ul class="space-y-2 text-sm">
                    <li><a href="<?php echo e(route('visitor.accueil')); ?>" class="hover:text-green-600 dark:hover:text-green-400 transition duration-200">Accueil</a></li>
            ...
            <div class="col-span-1">
                ...
                <ul class="space-y-2 text-sm">
                    <li><a href="<?php echo e(route('visitor.donate')); ?>" class="hover:text-green-600 dark:hover:text-green-400 transition duration-200">Faire un don</a></li>
                    <li><a href="<?php echo e(route('visitor.contact-us')); ?>" class="hover:text-green-600 dark:hover:text-green-400 transition duration-200">Contact et FAQ</a></li>
                    <li><a href="<?php echo e(route('visitor.galerie')); ?>" class="hover:text-green-600 dark:hover:text-green-400 transition duration-200">Galerie</a></li>
                </ul>
            </div>
...
[$__name, $__params] = $__split('contactetnewsletter::visitor.newsletter.newsletter-subscribe-form');

$__key = null;

$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-827533447-1', $__key);
...
?>
        ...
        <div class="flex flex-col md:flex-row justify-between items-center gap-4 pt-6">
            <p class="text-sm md:text-base order-2 md:order-1 font-medium">&copy; <?php echo e(date('Y')); ?> The Hope Charity. Tous droits réservés.</p>

            <div class="flex space-x-4 order-1 md:order-2">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($layoutContent->social_links['facebook'])): ?>
                    <a href="<?php echo e($layoutContent->social_links['facebook']); ?>" target="_blank" rel="noopener noreferrer"
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($layoutContent->social_links['twitter'])): ?>
                    <a href="<?php echo e($layoutContent->social_links['twitter']); ?>" target="_blank" rel="noopener noreferrer"
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($layoutContent->social_links['instagram'])): ?>
                    <a href="<?php echo e($layoutContent->social_links['instagram']); ?>" target="_blank" rel="noopener noreferrer"
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($layoutContent->social_links['linkedin'])): ?>
                    <a href="<?php echo e($layoutContent->social_links['linkedin']); ?>" target="_blank" rel="noopener noreferrer"
...
<?php /**PATH /home/athanor/Documents/PhpstormProjects/Hope/resources/views/visitor/layout.blade.php ENDPATH**/ ?>