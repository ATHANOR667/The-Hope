    ...
    <script>
        ...
        function heroVideo() {
            return {
                ...
                isLoading: false,
                player: null,
                posterUrl: '<?php echo e(($layoutContent->meta ?? [])["og:image"] ?? ""); ?>',
                // On récupère l'URL brute, on extraira l'ID via JS pour éviter l'erreur PHP
                videoRawUrl: '<?php echo e(($layoutContent->hero ?? [])["video_url"] ?? ""); ?>',
                videoId: null,
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/athanor/Documents/PhpstormProjects/Hope/resources/views/visitor/partials/home/hero_video_bg.blade.php ENDPATH**/ ?>