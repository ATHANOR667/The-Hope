...
<div class="email-wrapper">
    ...
    <div class="content">
        <p>Bonjour <span class="highlight"><?php echo e($donateur); ?></span>,</p>

        <p>Nous tenons à vous remercier chaleureusement pour votre généreux don de <span class="highlight"><?php echo e(number_format($montant, 0, ',', ' ')); ?> <?php echo e($devise); ?></span> en soutien à la cause des moins nantis.</p>
        ...
        <div class="transaction-details">
            ...
            <p>Référence : <span class="highlight"><?php echo e($reference); ?></span></p>
            <p>Montant : <span class="highlight"><?php echo e(number_format($montant, 0, ',', ' ')); ?> <?php echo e($devise); ?></span></p>
        </div>
    ...
    <div class="footer">
        <p>&copy; <?php echo e(date('Y')); ?> The Hope - Tous droits réservés.</p>
        <p><a href="<?php echo e(url('/')); ?>" style="color: #888; text-decoration: none;">Visitez notre site web</a></p>
    </div>
</div>
</body>
</html>
<?php /**PATH /home/athanor/Documents/PhpstormProjects/Hope/Modules/Donation/resources/views/Mail/Payment/donateFeedback.blade.php ENDPATH**/ ?>