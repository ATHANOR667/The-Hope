...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'coreui::components.modal','data' => ['wire:model' => 'showModal','title' => 'Créer une FAQ','maxWidth' => '4xl']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'showModal','title' => 'Créer une FAQ','maxWidth' => '4xl']); ?>
        <div class="space-y-6">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'coreui::components.input','data' => ['wire:model.blur' => 'question','label' => 'Question','placeholder' => 'Ex: Comment réinitialiser mon mot de passe ?','error' => ''.e($errors->first('question')).'','required' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model.blur' => 'question','label' => 'Question','placeholder' => 'Ex: Comment réinitialiser mon mot de passe ?','error' => ''.e($errors->first('question')).'','required' => true]); ?>
...
<?php $component->withAttributes(['class' => 'flex-1','wire:click' => 'save','wire:loading.attr' => 'disabled']); ?>
                    <span wire:loading.remove wire:target="save">Créer la FAQ</span>
...
<?php /**PATH /home/athanor/Documents/PhpstormProjects/Hope/Modules/ContactEtNewsletter/resources/views/livewire/admin/faq-manager/create-faq.blade.php ENDPATH**/ ?>