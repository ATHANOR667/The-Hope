...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <fieldset>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $allChannels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $channelKey => $channelData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <label for="<?php echo e($channelKey); ?>-channel"
                           class="relative flex flex-col items-center justify-center p-3 border rounded-lg cursor-pointer
                              text-gray-700 dark:text-gray-300
                              transition-all duration-200 ease-in-out
                              <?php if($selectedChannel === $channelKey): ?>
                              ...
                              <?php endif; ?>">
                        <input id="<?php echo e($channelKey); ?>-channel"
                               name="selectedChannel"
                               type="radio"
                               value="<?php echo e($channelKey); ?>"
                               wire:model.live="selectedChannel"
                               class="sr-only">
                        <svg class="h-5 w-5 mb-1 <?php echo e($selectedChannel === $channelKey ? 'text-green-600 dark:text-green-400' : 'text-gray-400 dark:text-gray-500'); ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <?php echo $channelData['icon']; ?>

                        </svg>
                        <span class="text-xs font-medium"><?php echo e($channelData['name']); ?></span>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedChannel === $channelKey): ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['selectedChannel'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php /**PATH /home/athanor/Documents/PhpstormProjects/Hope/Modules/ContactEtNewsletter/resources/views/livewire/visitor/newsletter/newsletter-subscribe-form.blade.php ENDPATH**/ ?>