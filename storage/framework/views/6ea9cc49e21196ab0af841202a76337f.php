                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                            <tr>
                                <td align="left" style="width: 50%; vertical-align: middle;">
                                    <img src="<?php echo e($logo); ?>" alt="The Hope Charity Logo" style="max-width: 150px; height: auto; display: block;">
                                </td>
                ...
                <tr>
                    <td style="padding: 30px;">
                        <p style="font-size: 16px; color: #333333; margin-bottom: 20px;">
                            Bonjour <strong style="color: #10B981;"><?php echo e($name); ?></strong> (<?php echo e($email); ?>),
                        </p>

                        <p style="font-size: 16px; color: #333333; margin-bottom: 20px;">
                            Nous vous confirmons la bonne réception de votre message concernant : <strong style="color: #333333;"><?php echo e($subject); ?></strong>.
                        </p>
                        ...
                        <div style="background-color: #F0FDF4; padding: 15px 20px; border-left: 4px solid #10B981; margin: 24px 0; border-radius: 4px;">
                            ...
                            <p style="margin: 12px 0 0 0; font-size: 15px; font-weight: 600; color: #10B981;">
                                Votre référence de conversation : <span style="font-family: monospace;">#<?php echo e($conversationId); ?></span>
                            </p>
                        </div>
...
<?php /**PATH /home/athanor/Documents/PhpstormProjects/Hope/Modules/ContactEtNewsletter/resources/views/mail/contact-confirmation.blade.php ENDPATH**/ ?>