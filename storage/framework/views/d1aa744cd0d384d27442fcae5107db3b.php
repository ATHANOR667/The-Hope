<section id="contact-feedback-section" class="py-16 sm:py-20 bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-950 rounded-t-3xl mt-12 sm:mt-20 shadow-2xl shadow-gray-300/40 dark:shadow-black/30 overflow-hidden transition-all duration-500">
    <div class="container mx-auto px-6 lg:px-8 max-w-5xl">
        ...
        <div class="grid md:grid-cols-2 gap-8 lg:gap-10">
            <!-- Carte Contact -->
            <a href="<?php echo e(route('visitor.contact-us')); ?>" class="group block bg-white dark:bg-gray-800/90 p-8 rounded-3xl shadow-lg hover:shadow-2xl border border-gray-100 dark:border-gray-700/50 transition-all duration-300 hover:-translate-y-1.5 hover:ring-4 hover:ring-green-500/10 backdrop-blur-sm">
            ...
            <!-- Carte FAQ -->
            <a href="<?php echo e(route('visitor.contact-us')); ?>" class="group block bg-white dark:bg-gray-800/90 p-8 rounded-3xl shadow-lg hover:shadow-2xl border border-gray-100 dark:border-gray-700/50 transition-all duration-300 hover:-translate-y-1.5 hover:ring-4 hover:ring-purple-500/10 backdrop-blur-sm">
                <div class="flex items-start space-x-4">
...
<?php /**PATH /home/athanor/Documents/PhpstormProjects/Hope/resources/views/visitor/partials/home/contact_feedback.blade.php ENDPATH**/ ?>